...
interface IRational {
	...
	default IRational add(IRational that) throws IllegalArgumentException {
		...
		int valueN = (this.getNumerator() * that.getDenominator()) + (that.getNumerator() * this.getDenominator());
		int valueD = (this.getDenominator() * that.getDenominator());
		return construct(valueN, valueD);
	}
	...
	default IRational mul(IRational that) throws IllegalArgumentException {
		...
		int valueN = (this.getNumerator() * that.getNumerator());
		int valueD = this.getDenominator() * that.getDenominator();
		return construct(valueN, valueD);
	}
	...
	default IRational div(IRational that) throws IllegalArgumentException {
		if((that == null) || (this.getNumerator() == 0)) {
			throw new IllegalArgumentException();
		}
		int valueN = (this.getNumerator() * that.getDenominator());
		int valueD = this.getDenominator() * that.getNumerator();
		return construct(valueN, valueD);
	}
}
