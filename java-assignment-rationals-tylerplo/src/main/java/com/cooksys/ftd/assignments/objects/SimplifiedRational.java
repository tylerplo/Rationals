...
public class SimplifiedRational implements IRational {
    ...
    public static int[] simplify(int numerator, int denominator) throws IllegalArgumentException {
        ...
        int[] simArray = new int[2];
        int gcd = gcd(Math.abs(numerator),Math.abs(denominator));
        simArray[0] = numerator/gcd;
        simArray[1] = denominator/gcd;
        return simArray;
    }
    ...
    public SimplifiedRational(int numerator, int denominator) throws IllegalArgumentException {
        ...
        if(numerator == 0) {
            ...
            int[] numbers = simplify(numerator, denominator);
            this.numerator = numbers[0];
            this.denominator = numbers[1];
        }
    ...
    public boolean equals(Object obj) {
        if(obj instanceof SimplifiedRational) {
            if(this.getNumerator() == ((SimplifiedRational) obj).getNumerator() && this.getDenominator() == ((SimplifiedRational) obj).getDenominator()) {
                return true;
            }
        }
        return false;
